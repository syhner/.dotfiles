...
cask "locationsimulator"                            # Application to spoof your iOS, iPadOS or iPhoneSimulator device location
...
cask "popclip"                                      # Used to access context-specific actions when text is selected
cask "purevpn"                                      # VPN client
...
mas "Color Picker", id: 1545870783                  # The built-in color picker
